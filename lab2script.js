mapboxgl.accessToken = 'pk.eyJ1IjoiamFuamFudyIsImEiOiJjbGRtMHNyNDYwMXh3M29rZHlscTNic2tqIn0.GKtLpllzMPD6I4AIRIS7Yw'; //Add default public map token from your Mapbox account 
...
// Add the control to the map for address search bar.
 map.addControl(
    new MapboxGeocoder({
    accessToken:'pk.eyJ1IjoiamFuamFudyIsImEiOiJjbGRtMHNyNDYwMXh3M29rZHlscTNic2tqIn0.GKtLpllzMPD6I4AIRIS7Yw',
    mapboxgl: mapboxgl
    })
    );
...
// Add the data from my mapbox tileset
    map.addSource('Pedestrain_Network_Data-46q6pd', {
        'type': 'vector',
        'url': 'https://studio.mapbox.com/tilesets/janjanw.bv9pgpop'
    });
// Style the lines by changing the colour, opacity, and outline colour. Also add source layer to get the data.
    map.addLayer({
        'id' : 'Pedestrain_Network_Data-46q6pd-fill',
        'type': 'fill',
        'source': 'Pedestrain_Network_Data-46q6pd',
        'paint': {
            'fill-color': '7CE593',
            'fill-opacity': 0.4,
            'fill-outline-color': 'black'
        },
        'source-layer': 'janjanw.bv9pgpop' 
    },
// Drawing order: this layer should be at the bottom of everything
        'Pedestrain_Network_Data-46q6pd'
